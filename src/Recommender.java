 ...
 * given to this method is for a new src.model.Rater that we have already added to the
 * src.model.RaterDatabase with ratings for the movies returned by the first method. Whatever is
 * printed from that method will be displayed on the web page: HTML, plain text, or debugging
 * information.
 */
public interface Recommender {
  /**
   * This method returns a list of movie IDs that will be used to look up the movies in the
   * src.model.MovieDatabase and present them to users to rate.
   *
   ...
   * movies.
   *
   * <p>The ratings for these movies will make the profile for a new src.model.Rater that will be
   * used to compare to for finding recommendations.
   */
   ...
   *
   * @param webRaterID the ID of a new src.model.Rater that has been already added to the
   *     src.model.RaterDatabase with ratings for the movies returned by the method getItemsToRate
   */
